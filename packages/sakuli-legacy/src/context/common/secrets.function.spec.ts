...
import {
    ...
    MASTERKEY_CLI_KEY,
    MASTERKEY_ENV_KEY,
    MASTERKEY_PROPERTY_KEY, withEncryption
...
describe("secrets", () => {
    ...
    describe('getEncryptionKey', () => {
        ...
        it("should throw on missing masterkey", () => {
            ...
            // THEN
            expect(testAction).toThrowError(`Masterkey could not be found in one of '--${MASTERKEY_CLI_KEY}' CLI option, '${MASTERKEY_PROPERTY_KEY}' property or '${MASTERKEY_ENV_KEY}' env var. Missing master key for secrets.`)
        });

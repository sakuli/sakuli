...
describe("sakuli region class", () => {
    ...
    it("should forward double clicks to mouse api", async () => {
        ...
        //THEN
        expect(runAsActionSpy).toBeCalledWith(testExecutionContextMock, "doubleClick", any(Function));
        expect(mouseApi.move).toBeCalledWith(sakuliRegion);
    ...
    it("should forward right clicks to mouse api", async () => {
        ...
        //THEN
        expect(runAsActionSpy).toBeCalledWith(testExecutionContextMock, "rightClick", any(Function));
        expect(mouseApi.move).toBeCalledWith(sakuliRegion);
    ...
    it("should press given mouse button on mouseDown", async () => {
        ...
        //THEN
        expect(runAsActionSpy).toBeCalledWith(testExecutionContextMock, "mouseDown", any(Function));
    ...
    it("should release given mouse button on mouseUp", async () => {
        ...
        //THEN
        expect(runAsActionSpy).toBeCalledWith(testExecutionContextMock, "mouseUp", any(Function));
    ...
    it("should drag and drop to target region", async () => {
        ...
        //THEN
        expect(runAsActionSpy).toBeCalledWith(testExecutionContextMock, "dragAndDropTo", any(Function));

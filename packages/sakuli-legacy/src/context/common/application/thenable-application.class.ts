...
export function createThenableApplicationClass(
  ctx: TestExecutionContext,
  project: Project
): Type<ThenableApplication> {
  ...
  return class ThenableSakuliApplication {
    constructor(
      ...
      readonly application: Promise<Application> = Promise.resolve(
    ...
    then<TResult1 = Application, TResult2 = never>(
      onfulfilled?:
        | ((value: Application) => PromiseLike<TResult1> | TResult1)
        | undefined
        | null,
      onrejected?:
      ...
      return this.application.then(onfulfilled, onrejected);
    }
  };
}

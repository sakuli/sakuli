...
export class NativeEventDispatcher {
  ...
  async dispatchAudioProcessingEvent(
    name: string,
    init: AudioProcessingEventInit
  ) {
  ...
  async dispatchDeviceOrientationEvent(
    name: string,
  ...
  async dispatchIDBVersionChangeEvent(
    name: string,
  ...
  async dispatchOfflineAudioCompletionEvent(
    name: string,
  ...
  async dispatchPaymentRequestUpdateEvent(
    name: string,
  ...
  async dispatchRTCDataChannelEvent(
    name: string,
  ...
  async dispatchRTCPeerConnectionIceEvent(
    name: string,

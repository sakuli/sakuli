...
type TestExecutionContextEntityEventListener<T extends TestContextEntity> = (
  e: T
) => void;

export type TestSuiteChangeListener = TestExecutionContextEntityEventListener<
  TestSuiteContext
>;
export type TestSuiteEndListener = TestExecutionContextEntityEventListener<
  TestSuiteContext & FinishedMeasurable
>;
export type TestCaseChangeListener = TestExecutionContextEntityEventListener<
  TestCaseContext
>;
export type TestCaseEndListener = TestExecutionContextEntityEventListener<
  TestCaseContext & FinishedMeasurable
>;
export type TestStepChangeListener = TestExecutionContextEntityEventListener<
  TestStepContext
>;
export type TestStepEndListener = TestExecutionContextEntityEventListener<
  TestStepContext & FinishedMeasurable
>;
export type TestActionChangeListener = TestExecutionContextEntityEventListener<
  TestActionContext
>;
export type TestActionEndListener = TestExecutionContextEntityEventListener<
  TestActionContext & FinishedMeasurable
>;

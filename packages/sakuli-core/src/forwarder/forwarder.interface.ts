...
export interface Forwarder {
   ...
   */
  forwardSuiteResult?(
    entity: TestSuiteContext & FinishedMeasurable,
   ...
   */
  forwardCaseResult?(
    entity: TestCaseContext & FinishedMeasurable,
    ctx: TestExecutionContext
  ): Promise<void>;
   ...
   */
  forwardStepResult?(
    entity: TestStepContext & FinishedMeasurable,
    ctx: TestExecutionContext
  ): Promise<void>;
   ...
   */
  forwardActionResult?(
    entity: TestActionContext & FinishedMeasurable,
    ctx: TestExecutionContext
  ): Promise<void>;

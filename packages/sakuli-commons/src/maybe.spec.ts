import { ensure, ifPresent, isPresent, Maybe } from "./maybe";

describe("Maybe", () => {
  describe("isPresent", () => {
    it("should recognize null to be false", () =>
      expect(isPresent(null)).toBeFalsy());
    it("should recognize undefined to be false", () =>
      expect(isPresent(undefined)).toBeFalsy());
    it("should recognize NaN to be false", () =>
      expect(isPresent(NaN)).toBeFalsy());
    it("should recognize 0 to be true", () =>
      expect(isPresent(0)).toBeTruthy());
    it("should recognize empty string to be true", () =>
      expect(isPresent("")).toBeTruthy());
    it("should recognize empty object to be true", () =>
      expect(isPresent({})).toBeTruthy());
    it("should recognize empty array to be true", () =>
      expect(isPresent([])).toBeTruthy());
  });

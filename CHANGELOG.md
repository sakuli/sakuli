...
- Bugfix: Dependency of get-cursor-position (@sakuli/cli) breaks npm install when python is not installed DONE Type: Enhancement [(#117)](https://github.com/sakuli/sakuli/issues/117)
